...
<div class="form-row">
	<div class="form-group col-xl-6 col-md-6">
		<p>Valor Mensal: <strong><?php echo number_format($monthly, 2)?> MT</strong></p>
		<p>Multa: <strong><?php echo number_format($add, 2)?> MT</strong></p>
		<p>Valor a Pagar: <strong> <?php echo number_format($monthly+$add, 2)?> MT</strong></p>
	</div>
	<div class="form-group col-xl-6 col-md-6">
